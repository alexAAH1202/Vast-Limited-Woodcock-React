            ...
            <div className="footer2-container1">
              <div className="footer2-column1">
                <strong className="thq-body-large">
                  {props.column1Title ?? (
                    <Fragment>
                      <span className="footer2-text22">Company</span>
                    </Fragment>
                  )}
                </strong>
                <div className="footer2-footer-links1">
                  ...
                  >
                    {props.link1 ?? (
                      <Fragment>
                        <span className="footer2-text13">/about</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link2 ?? (
                      <Fragment>
                        <span className="footer2-text23">/contact</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link3 ?? (
                      <Fragment>
                        <span className="footer2-text25">/faq</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link4 ?? (
                      <Fragment>
                        <span className="footer2-text12">/support</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link5 ?? (
                      <Fragment>
                        <span className="footer2-text21">/blog</span>
                      </Fragment>
                    )}
                  </a>
                </div>
              ...
              <div className="footer2-column2">
                <strong className="thq-body-large">
                  {props.column2Title ?? (
                    <Fragment>
                      <span className="footer2-text27">Legal</span>
                    </Fragment>
                  )}
                </strong>
                <div className="footer2-footer-links2">
                  ...
                  >
                    {props.link6 ?? (
                      <Fragment>
                        <span className="footer2-text15">/careers</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link7 ?? (
                      <Fragment>
                        <span className="footer2-text24">/press</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link8 ?? (
                      <Fragment>
                        <span className="footer2-text19">/partners</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link9 ?? (
                      <Fragment>
                        <span className="footer2-text11">/investors</span>
                      </Fragment>
                    )}
                  </a>
                  <a
                  ...
                  >
                    {props.link10 ?? (
                      <Fragment>
                        <span className="footer2-text14">/sitemap</span>
                      </Fragment>
                    )}
                  </a>
                </div>
              ...
              <div className="footer2-form">
                ...
                <button className="thq-button-outline footer2-button">
                  <span className="thq-body-small">
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer2-text18">Subscribe</span>
                      </Fragment>
                    )}
                  </span>
                </button>
            ...
            <div className="footer2-credits2">
              ...
              <div className="footer2-footer-links3">
                ...
                <span className="thq-body-small">
                  {props.termsLink ?? (
                    <Fragment>
                      <span className="footer2-text20">/terms</span>
                    </Fragment>
                  )}
                </span>
                <span className="thq-body-small">
                  {props.cookiesLink ?? (
                    <Fragment>
                      <span className="footer2-text16">/cookies</span>
                    </Fragment>
                  )}
                </span>
              </div>
