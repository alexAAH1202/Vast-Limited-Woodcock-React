        ...
        <div className="footer1-content">
          <div className="footer1-newsletter">
            <span className="thq-body-small">
              Refer a friend and get 1000 free SMS Credits!
            </span>
              ...
              <div className="footer1-form">
                ...
                <button className="thq-button-outline footer1-button">
                  <span className="thq-body-small">
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer1-text25">Refer Now</span>
                      </Fragment>
                    )}
                  </span>
                </button>
          ...
          <div className="footer1-links">
            <div className="footer1-column1">
              <strong className="thq-body-large footer1-column1-title">
                {props.column1Title ?? (
                  <Fragment>
                    <span className="footer1-text20">Company</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links1">
                ...
                >
                  {props.link1 ?? (
                    <Fragment>
                      <span className="footer1-text11">About Us</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link3 ?? (
                    <Fragment>
                      <span className="footer1-text14">FAQ</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link4 ?? (
                    <Fragment>
                      <span className="footer1-text17">Terms of Use</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link5 ?? (
                    <Fragment>
                      <span className="footer1-text15">Privacy Policy</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column2">
              <strong className="thq-body-large footer1-column2-title">
                {props.column2Title ?? (
                  <Fragment>
                    <span className="footer1-text24">Legal</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer1-footer-links2">
                ...
                >
                  {props.link6 ?? (
                    <Fragment>
                      <span className="footer1-text21">Cookies Policy</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link8 ?? (
                    <Fragment>
                      <span className="footer1-text28">Special Offers</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link9 ?? (
                    <Fragment>
                      <span className="footer1-text19">Exclusive Content</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer1-text22">Join Now</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer1-column3">
              <strong className="thq-body-large footer1-social-link1-title">
                {props.socialLinkTitleCategory ?? (
                  <Fragment>
                    <span className="footer1-text10">Connect with Us</span>
                  </Fragment>
                )}
              </strong>
          ...
          <div className="footer1-row">
            ...
            <div className="footer1-footer-links3">
              <span className="thq-body-small">
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer1-text23">/privacy</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer1-text27">/terms</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer1-text26">/cookies</span>
                  </Fragment>
                )}
              </span>
            </div>
