      ...
      <div className="pricing8-max-width thq-section-max-width">
        <div className="pricing8-section-title">
          <span className="pricing8-text100 thq-body-small">
            {props.content1 ?? (
              <Fragment>
                <span className="pricing8-text189">Pricing plans</span>
              </Fragment>
            )}
          </span>
            ...
            <div className="pricing8-column1 thq-card">
              ...
              <div className="pricing8-price10">
                <div className="pricing8-price11">
                  <p className="pricing8-text107 thq-body-large">
                    {props.plan1 ?? (
                      <Fragment>
                        <span className="pricing8-text184">Basic Plan</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing8-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing8-text205">$9.99/month</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text203">$99/year</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <button className="pricing8-button14 thq-button-animated thq-button-outline">
                <span className="thq-body-small">
                  {props.plan1Action ?? (
                    <Fragment>
                      <span className="pricing8-text204">Sign Up Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column2 thq-card">
              ...
              <div className="pricing8-price12">
                <div className="pricing8-price13">
                  <p className="pricing8-text114 thq-body-large">
                    {props.plan2 ?? (
                      <Fragment>
                        <span className="pricing8-text202">Business plan</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing8-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing8-text193">$29/mo</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text176">or $299 yearly</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing8-list2">
                  ...
                  <div className="pricing8-list-item15">
                    ...
                    <span className="thq-body-small">
                      {props.plan2Feature3 ?? (
                        <Fragment>
                          <span className="pricing8-text201">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button15 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan2Action ?? (
                    <Fragment>
                      <span className="pricing8-text163">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <div className="pricing8-price14">
                <div className="pricing8-price15">
                  ...
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing8-text168">or $499 yearly</span>
                      </Fragment>
                    )}
                  </p>
                </div>
            ...
            <div className="pricing8-column4 thq-card">
              ...
              <div className="pricing8-price16">
                <div className="pricing8-price17">
                  ...
                  <h3 className="pricing8-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text185">$9.99</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text206">$99</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <button className="pricing8-button17 thq-button-animated thq-button-outline">
                <span className="thq-body-small">
                  {props.plan1Action1 ?? (
                    <Fragment>
                      <span className="pricing8-text155">Upgrade</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column5 thq-card">
              ...
              <div className="pricing8-price18">
                <div className="pricing8-price19">
                  <span className="pricing8-text138 thq-body-large">
                    {props.plan21 ?? (
                      <Fragment>
                        <span className="pricing8-text191">Business plan</span>
                      </Fragment>
                    )}
                  </span>
                  <h3 className="pricing8-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text174">$299/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text166">or $29 monthly</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <button className="pricing8-button18 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan2Action1 ?? (
                    <Fragment>
                      <span className="pricing8-text171">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing8-column6 thq-card">
              ...
              <div className="pricing8-price20">
                <div className="pricing8-price21">
                  <span className="pricing8-text146 thq-body-large">
                    {props.plan31 ?? (
                      <Fragment>
                        <span className="pricing8-text164">
                          Enterprise plan
                        </span>
                      </Fragment>
                    )}
                  ...
                  <h3 className="pricing8-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing8-text196">$499/year</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing8-text179">or $49 monthly</span>
                      </Fragment>
                    )}
                  </span>
                </div>
                  ...
                  <div className="pricing8-list-item31">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature31 ?? (
                        <Fragment>
                          <span className="pricing8-text183">
                            Feature text goes here
                          </span>
                        </Fragment>
                      )}
              ...
              <button className="pricing8-button19 thq-button-filled thq-button-animated">
                <span className="thq-body-small">
                  {props.plan3Action1 ?? (
                    <Fragment>
                      <span className="pricing8-text181">Get started</span>
                    </Fragment>
                  )}
                </span>
              </button>
