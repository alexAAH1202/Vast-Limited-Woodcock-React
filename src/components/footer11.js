          ...
          <div className="footer11-newsletter">
            ...
            <div className="footer11-actions">
              <div className="footer11-form">
                ...
                <button className="thq-button-outline footer11-button">
                  <span className="thq-body-small">
                    {props.action1 ?? (
                      <Fragment>
                        <span className="footer11-text23">
              ...
              <span className="footer11-content2 thq-body-small">
                {props.content2 ?? (
                  <Fragment>
                    <span className="footer11-text22">
          ...
          <div className="footer11-links">
            <div className="footer11-column1">
              <strong className="thq-body-large footer11-column1-title">
                {props.column1Title ?? (
                  <Fragment>
                    <span className="footer11-text11">Company</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer11-footer-links1">
                ...
                >
                  {props.link1 ?? (
                    <Fragment>
                      <span className="footer11-text16">Home</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link2 ?? (
                    <Fragment>
                      <span className="footer11-text15">Sign In</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link3 ?? (
                    <Fragment>
                      <span className="footer11-text12">Create Account</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link4 ?? (
                    <Fragment>
                      <span className="footer11-text21">Terms of Use</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link5 ?? (
                    <Fragment>
                      <span className="footer11-text28">Privacy Policy</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer11-column2">
              <strong className="thq-body-large footer11-column2-title">
                {props.column2Title ?? (
                  <Fragment>
                    <span className="footer11-text24">Quick Links</span>
                  </Fragment>
                )}
              </strong>
              <div className="footer11-footer-links2">
                ...
                >
                  {props.link6 ?? (
                    <Fragment>
                      <span className="footer11-text25">Contact Us</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link7 ?? (
                    <Fragment>
                      <span className="footer11-text14">FAQ</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link8 ?? (
                    <Fragment>
                      <span className="footer11-text20">Support</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link9 ?? (
                    <Fragment>
                      <span className="footer11-text17">About Us</span>
                    </Fragment>
                  )}
                </a>
                <a
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer11-text26">Careers</span>
                    </Fragment>
                  )}
                </a>
              </div>
            ...
            <div className="footer11-column3">
              <strong className="thq-body-large footer11-social-link1-title">
                {props.socialLinkTitleCategory ?? (
                  <Fragment>
                    <span className="footer11-text19">Follow Us</span>
                  </Fragment>
                )}
              </strong>
        ...
        <div className="footer11-credits">
          ...
          <div className="footer11-row">
            <span className="thq-body-small">
              {props.content3 ?? (
                <Fragment>
                  <span className="footer11-text27">
            ...
            <div className="footer11-footer-links3">
              <span className="thq-body-small">
                {props.privacyLink ?? (
                  <Fragment>
                    <span className="footer11-text10">/privacy-policy</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer11-text13">/terms-of-use</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer11-text18">/cookies-policy</span>
                  </Fragment>
                )}
              </span>
            </div>
