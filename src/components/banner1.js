      ...
      <div className="banner1-max-width thq-section-max-width">
        <div className="banner1-container2">
          <h2 className="banner1-title thq-heading-2">
            {props.heading1 ?? (
              <Fragment>
                <span className="banner1-text4">Sign Up Today!</span>
              </Fragment>
            )}
          </h2>
            ...
            {props.content1 ?? (
              <Fragment>
                <span className="banner1-text3">
                  Join our community by creating an account and start exploring
                  exclusive features.
                </span>
              </Fragment>
            )}
        ...
        <button type="button" className="thq-button-filled">
          <span>
            {props.action1 ?? (
              <Fragment>
                <span className="banner1-text5">Create Account</span>
              </Fragment>
            )}
          </span>
        </button>
