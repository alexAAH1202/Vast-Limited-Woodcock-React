              ...
              <div className="navbar6-menu-item1">
                ...
                <div className="navbar6-content1">
                  <span className="navbar6-page11 thq-body-large">
                    {props.page1 ?? (
                      <Fragment>
                        <span className="navbar6-text19">Page One</span>
                      </Fragment>
                    )}
                  </span>
              ...
              <div className="navbar6-menu-item2">
                ...
                <div className="navbar6-content2">
                  <span className="navbar6-page21 thq-body-large">
                    {props.page2 ?? (
                      <Fragment>
                        <span className="navbar6-text11">Page Two</span>
                      </Fragment>
                    )}
                  </span>
                  <span className="thq-body-small">
              ...
              <div className="navbar6-menu-item3">
                ...
                <div className="navbar6-content3">
                  <span className="navbar6-page31 thq-body-large">
                    {props.page3 ?? (
                      <Fragment>
                        <span className="navbar6-text16">Page Three</span>
                      </Fragment>
                    )}
                  </span>
                  <span className="thq-body-small">
              ...
              <div className="navbar6-menu-item4">
                ...
                <div className="navbar6-content4">
                  <span className="navbar6-page41 thq-body-large">
                    {props.page4 ?? (
                      <Fragment>
                        <span className="navbar6-text12">Page Four</span>
                      </Fragment>
                    )}
                  </span>
                  <span className="thq-body-small">
        ...
        <div data-thq="thq-navbar-nav" className="navbar6-desktop-menu">
          <nav className="navbar6-links1">
            <a href={props.link1Url} className="thq-body-small thq-link">
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar6-text10">Home</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar6-text22">Features</span>
                </Fragment>
              )}
            </a>
            <a href={props.link3Url} className="thq-body-small thq-link">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar6-text20">Sign Up</span>
                </Fragment>
              )}
            </a>
            <a href={props.link4Url} className="thq-body-small thq-link">
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar6-text13">Terms of Use</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-body-small thq-link">
                {props.link5 ?? (
                  <Fragment>
                    <span className="navbar6-text18">Privacy Policy</span>
                  </Fragment>
                )}
              </span>
...
Navbar6.defaultProps = {
  ...
  page2ImageAlt: 'image',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1687720657052-c026be7f388c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDg2MjUwNnw&ixlib=rb-4.0.3&q=80&w=1080',
  page2: undefined,
  page4: undefined,
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1468421870903-4df1664ac249?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDg2MjUwNXw&ixlib=rb-4.0.3&q=80&w=1080',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1567428486597-8c5328fd3816?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDg2MjUwNnw&ixlib=rb-4.0.3&q=80&w=1080',
  ...
  page4ImageAlt: 'image',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1468056961052-15507578a50d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMDg2MjUwNXw&ixlib=rb-4.0.3&q=80&w=1080',
  link5: undefined,
  page3ImageAlt: 'image',
  page1: undefined,
  page1ImageAlt: 'image',
